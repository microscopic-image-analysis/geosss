...
if __name__ == "__main__":
    ...
    print(f" In total, {a.my_method.__name__} was called {a.my_method.num_calls} times")
    print(
        f" In total, {a.another_method.__name__} was called "
    ...
    print(
        f" In total, {b.my_method.__name__} from subclass was called "
        f"{b.my_method.num_calls} times"
    )

    [test_func() for _ in range(3)]
    print(
        f" In total, function {test_func.__name__} was called "
