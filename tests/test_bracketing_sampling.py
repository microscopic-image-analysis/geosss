# testing the slice sampling bracketing procedure for a 3d bingham distribution
...
# bracketing slice sampler
z = testing.slice_sampling(pdf, burnin + n_samples)[burnin:]
